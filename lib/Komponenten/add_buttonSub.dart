...
class AddButtonSub extends StatelessWidget {
  String parentID;
  AddButtonSub (this.parentID, { Key? key }) : super(key: key);
    ...
    return PopupMenuButton(
      ...
      itemBuilder: (context) => <PopupMenuEntry<String>>[
        ...
        PopupMenuItem(
          value: 'whitebird',
          child: ListTile(
            leading: Image.asset(whichTypePath('whitebird'),color: Colors.white, height: 25),
  ...
  Future<dynamic> DialogScreen(BuildContext context, GlobalKey<FormState> _formKey, type) {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  Row(
                    ...
                    children: [
                      Image.asset(whichTypePath(type), height: 50, color: Colors.white),
                      Text(whichType(type),style: Theme.of(context).textTheme.headline5),
                    ],
                  ),
                      ...
                      ElevatedButton(
                        onPressed: (){
                          if(_formKey.currentState!.validate()){
                            createItem(context, type, _nameController.text, parentID);
...
createItem(context,type, name,  parentID){
  
  Provider.of<ItemListSub>(context, listen: false).create(type, name, parentID);
